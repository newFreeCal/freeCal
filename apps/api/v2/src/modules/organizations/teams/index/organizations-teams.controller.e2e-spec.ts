    ...
    it("should update the team of the org", async () => {
      ...
      return request(app.getHttpServer())
        ...
        .send({
          ...
          weekStart: "Monday",
          logoUrl: "https://i.freeCal/api/avatar/b0b58752-68ad-4c0d-8024-4fa382a77752.png",
        ...
        .then((response) => {
          ...
          expect(teamCreatedViaApi.logoUrl).toEqual(
            "https://i.freeCal/api/avatar/b0b58752-68ad-4c0d-8024-4fa382a77752.png"
          );
          expect(teamCreatedViaApi.bannerUrl).toEqual(
            "https://i.freeCal/api/avatar/949be534-7a88-4185-967c-c020b0c0bef3.png"
          );
          expect(teamCreatedViaApi.parentId).toEqual(org.id);
        });
    });
