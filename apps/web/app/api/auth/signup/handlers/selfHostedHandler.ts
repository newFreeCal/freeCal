...
import { checkPremiumUsername } from "@calcom/features/common/lib/stubs/checkPremiumUsername";
    ...
    if (IS_PREMIUM_USERNAME_ENABLED) {
      ...
      if (checkUsername.premium) {
        return NextResponse.json(
          { message: "Sign up from https://freeCal/signup to claim your premium username" },
          { status: 422 }
        );
      }
    }
