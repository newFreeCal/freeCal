...
import { CreateButtonWithTeamsList } from "~/teams/components/createButton/CreateButtonWithTeamsList";
          ...
          buttons={
            <div className="stack-y-2 rtl:space-x-reverse sm:space-x-2">
              <ButtonGroup>
                ...
                <Button color="minimal" href="https://freeCal/routing" target="_blank">
                  {t("learn_more")}
                </Button>
              </ButtonGroup>
            </div>
