...
// For app.freeCal, it will match all domains that are not starting with "app". Technically we would want to match domains like acme.freeCal, dunder.freeCal and not app.freeCal
