                        ...
                        <div className="text-default pt-8 text-center text-xs">
                          ...
                          <form
                            onSubmit={(e) => {
                              ...
                              router.push(`https://freeCal/signup?email=${target.email.value}`);
                            }}
                            className="mt-4 flex">
                            <EmailInput
                              name="email"
                              ...
                              placeholder="rick.astley@freeCal"
                            />
                            <Button
                              type="submit"
                  ...
                  message={
                    <div>
                      ...
                      <span className="underline">
                        <a
                          target="_blank"
                          href="https://freeCal/blog/google-s-new-spam-policy-may-be-affecting-your-invitations"
                          rel="noreferrer">
                          {t("resolve")}
                        </a>
                      </span>
