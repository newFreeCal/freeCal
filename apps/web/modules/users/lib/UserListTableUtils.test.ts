...
describe("generate Csv for Org Users Table", () => {
  const orgDomain = "https://acme.freeCal";
  ...
  it("should handle user with single attribute value", () => {
    ...
    expect(csv).toMatchInlineSnapshot(`
      ...
      test@example.com,https://acme.freeCal/testuser,MEMBER,Team1,value1,"
    `);
  });
  ...
  it("should handle user with multiple attribute values for same attribute", () => {
    ...
    expect(csv).toMatchInlineSnapshot(`
      "Members,Link,Role,Teams,Attribute 1,Attribute 2
      test@example.com,https://acme.freeCal/testuser,MEMBER,Team1,"value1,value2","
    `);
  });
  ...
  it("should handle user with multiple teams", () => {
    ...
    expect(csv).toMatchInlineSnapshot(`
      "Members,Link,Role,Teams,Attribute 1,Attribute 2
      test@example.com,https://acme.freeCal/testuser,MEMBER,"Team1,Team2",,"
    `);
  });
  ...
  it("should handle values that need sanitization", () => {
    ...
    expect(csv).toMatchInlineSnapshot(`
      "Members,Link,Role,Teams,Attribute 1,Attribute 2
      test@example.com,https://acme.freeCal/testuser,MEMBER,"Team,1","value,1","
    `);
  });
  ...
  it("should handle all membership roles", () => {
    ...
    expect(csv).toMatchInlineSnapshot(`
      "Members,Link,Role,Teams,Attribute 1,Attribute 2
      owner@example.com,https://acme.freeCal/owner,OWNER,,,
      admin@example.com,https://acme.freeCal/admin,ADMIN,,,
      member@example.com,https://acme.freeCal/member,MEMBER,,,"
    `);
  });
  ...
  it("should handle users without teams and attributes", () => {
    ...
    expect(csv).toMatchInlineSnapshot(`
      "Members,Link,Role,Teams,Attribute 1,Attribute 2
      test@example.com,https://acme.freeCal/testuser,MEMBER,,,"
    `);
  });
});
