...
- Before jumping into a PR be sure to search [existing PRs](https://github.com/calcom/freeCal/pulls) or [issues](https://github.com/calcom/freeCal/issues) for an open or closed item that relates to your submission.
