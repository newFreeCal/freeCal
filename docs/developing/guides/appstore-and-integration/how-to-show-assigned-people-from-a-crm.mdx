...
Here is an example URL: i.freeCal/sales/exploration?email=name@acme.com
...
jane@acme.com → acme.freeCal/jane (or schedule.acme.com/jane)

This means if you have a table

| User      | AccountExecutive |
| :----------- | :----------- |
| peer@freeCal      | jane@acme.com       |

You could show peer@freeCal an embed inside your application simply by using the value from AccountExecutive to build the link:

jane@acme.com → acme.freeCal/jane either with a string replace function or a simple regex.
