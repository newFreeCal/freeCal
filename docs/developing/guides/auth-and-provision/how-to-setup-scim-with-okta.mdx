<Steps>
    ...
    <Step title="Go to Directory Sync in freeCal">
        Next, go to your instance of freeCal and navigate to `https://app.freeCal/settings/organization/dsync` and click configure.
    ...
    <Step title="Setup Provisioning in Okta">
        ...
        - Under "SCIM connector base URL" enter the "SCIM Base URL" from freeCal
        ...
        - Under "Authentication" enter the "SCIM Bearer Token" from freeCal
...
## Mapping Okta Groups to freeCal Teams
...
On `https://app.freeCal/settings/organization/dsync`, there is a table with the teams under your organization. Click on "Add group name" to map the Okta group to the team.
