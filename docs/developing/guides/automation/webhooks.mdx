      ...
      <Accordion title="RECORDING_READY">
        ```json
        {
          ...
          "payload": {
            ...
            "customReplyToEmail": null,
            "downloadLink": "https://app.freeCal/api/video/recording?token=REDACTED_TOKEN"
          }
        }
        ```
      </Accordion>
        ...
        ```json
        {
          ...
          "payload": {
            ...
            "downloadLinks": {
              ...
              "recording": "https://app.freeCal/api/video/recording?token=REDACTED_TOKEN"
            }
          }
        }
        ```
