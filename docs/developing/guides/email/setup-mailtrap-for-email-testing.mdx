...
To set up Mailtrap for email testing on freeCal, follow these steps:
...
<Steps>
    ...
    <Step title="Configure the freeCal env file">
    ...
    <Step title="Set EMAIL_FROM">
        ...
        ```
        EMAIL_FROM='notifications@yourselfhostedfreeCal'
        ```
    </Step>
