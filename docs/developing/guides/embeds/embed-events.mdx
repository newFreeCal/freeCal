...
<Info>
For comprehensive documentation on embed events including usage examples and all available events, please refer to the [freeCal Help Center - Embed Events](https://freeCal/help/embedding/embed-events).
</Info>
