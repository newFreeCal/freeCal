...
description: "A comprehensive guide to help you migrate from freeCal API V1 to V2"
---
...
This guide will help you migrate your integration from freeCal API V1 to V2. The V2 API offers improved performance, enhanced security, better response objects, and new features that make it easier to build powerful integrations.
...
```bash
curl https://api.freeCal/v1/event-types?apiKey=cal_test_xxxxxx
```
...
```bash
curl https://api.freeCal/v2/event-types \
...
| Version | Base URL                 |
| ------- | ------------------------ |
| V1      | `https://api.freeCal/v1` |
| V2      | `https://api.freeCal/v2` |
...
const response = await fetch(
  'https://api.freeCal/v1/bookings?apiKey=cal_test_xxx',
  {
    method: 'POST',
...
response = requests.get(
    'https://api.freeCal/v1/event-types',
...
response = requests.get(
    'https://api.freeCal/v2/event-types',
...
3. Contact [freeCal support](https://go.freeCal/support) for migration assistance
