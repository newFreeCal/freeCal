...
description: "Complete guide for migrating your freeCal integration from v1 to v2"
---
...
- **New features**: Access to new freeCal features only available in v2
...
```bash
curl https://api.freeCal/v1/bookings?apiKey=cal_test_xxxxxx
```

In v2, you authenticate using an API key in the `Authorization` header:

```bash
curl https://api.freeCal/v2/bookings \
