...
The freeCal API uses API keys to authenticate requests. You can view and manage your API keys in your settings page under the security tab in freeCal.
...
Authentication to the API is performed via URL Query Params. Provide your API key as a query param like: `https://api.freeCal/v1/?apiKey=cal_live_xxxxxx`
