...
You can generate an API key from **Settings >** [**Security**](https://app.freeCal/settings/security) within the application. There you will find the API keys section which allows you to generate a key for use.
