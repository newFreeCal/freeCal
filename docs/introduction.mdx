---
title: Documentation
description: Welcome to the official freeCal docs. To help get you started, we've put together a few resources to help you learn about how to use freeCal. We have also provided advanced documentation covering how to build on top of freeCal both in the codebase, by API and more. These guides will go into depth on how you can best integrate and extend freeCal for your needs.
hugeTitle: true
fullWidth: true
omitFeedback: true
---
...
freeCal offers a variety of premium features which can be accessed through acquiring the enterprise license. To get an idea of what you get in return for the enterprise license, you can head to our Enterprise Features section:
...
The freeCal API is a REST-styled API that gives full control over the entire freeCal platform by providing all the resources available to our customers, exposed as simple HTTP endpoints.
The freeCal API is organized around REST. Our API has predictable resource-oriented URLs, accepts JSON-encoded request bodies, returns JSON-encoded responses, and uses standard HTTP response codes, authentication, and verbs.
...
<div className="not-prose grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-6">
    ...
    <PlainCard
      ...
      description="Get access to the full freeCal source code"
      customBackground="#141414"
      Icon={GitHub} />
</div>
