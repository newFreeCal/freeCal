...
This guide will walk you through setting up and configuring the organizations feature for your self-hosted freeCal instance. Organizations allow you to create branded, multi-tenant environments within your freeCal deployment.

## Prerequisites

Before setting up organizations, ensure you have:
- A working freeCal instance already installed and running
- Admin access to your freeCal instance
...
<Note>
After creating the organization, you'll be moved inside it and all existing freeCal links will redirect to the organization URL (e.g., `yourdomain.cal.local:3000`).
</Note>
...
Read more about some other [Organization related environment variables](./understanding-organization-env-variables.mdx) to configure your freeCal instance to work with multiple organizations.
