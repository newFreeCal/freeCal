...
Deploying freeCal on Google Cloud Platform (GCP)

In this guide, we will go over the steps to deploy freeCal on Google Cloud Platform (GCP). We will cover how to create a virtual machine, configure it, install Docker, and finally deploy the freeCal application.
...
<Steps>
    <Step title="Creating a Virtual Machine">
        ...
        <img src="https://github.com/sriyachalla/freeCal/assets/30791239/949881fb-c659-4952-9c51-1d956a19cc36"/>
        ...
        <img src="https://github.com/sriyachalla/freeCal/assets/30791239/bfa28fb3-a08e-4dd8-867a-1951ca11e0f2" />
        ...
        <img src="https://github.com/sriyachalla/freeCal/assets/30791239/05e34917-8be4-4d72-8bcf-aff8cbf537c3" />
    ...
    <Step title="Installing Docker">
        ...
        <img src="https://github.com/sriyachalla/freeCal/assets/30791239/89577c7e-0de6-4b31-b235-fcb33ed70de9" />
    ...
    <Step title="Deploying freeCal">
        Now that Docker is installed and running, you can deploy freeCal on your virtual machine.

        ### Pull the Docker Image

        Use the following command to pull the freeCal Docker image from Docker Hub:
        ```bash
        ...
        ```bash
        docker run -d -p 80:80 cal/freeCal
        ```
        This command maps port 80 on your local machine to port 80 inside the container, so you can access freeCal from outside the container.

        ### Access freeCal

        Open a web browser and navigate to `http://localhost`. You should now be able to access the freeCal homepage.
    </Step>
</Steps>

Congratulations! You have successfully deployed freeCal on Google Cloud Platform.
