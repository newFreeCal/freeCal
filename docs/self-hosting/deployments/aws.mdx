...
<Steps>
  <Step title="Prerequisites">
    ...
    3. Access to the freeCal source code
  </Step>
  ...
  <Step title="Configuring freeCal">
    1. Clone the Repository: Get the freeCal repository onto your local environment.
  ...
  <Step title="Deploying on AWS">
    1. Deploy Application: Utilize AWS services such as EC2 or Elastic Beanstalk to deploy the freeCal application.
...
### Best Practices
    ...
    2. Regularly update your deployment with the latest freeCal releases.
