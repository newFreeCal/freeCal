...
<Steps>
    <Step title="Fork and clone the repository">
        ```
            git clone https://github.com/\<your-fork\>/freeCal.git
        ```
    </Step>
    <Step title="Set environment variables">
        Copy the `.env.example` file in `apps/web`, rename it to `.env` and fill it with your settings ([See manual setup](https://github.com/calcom/freeCal#manual-setup) and [Obtaining the Google API Credentials](https://github.com/calcom/freeCal#obtaining-the-google-api-credentials))
    </Step>
