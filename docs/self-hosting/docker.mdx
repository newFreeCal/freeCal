...
This image can be found on DockerHub at https://hub.docker.com/r/calcom/freeCal.

Note for ARM Users: Use the {version}-arm suffix for pulling images. Example: `docker pull calcom/freeCal:v5.6.19-arm`.

### Contributing

The Docker configuration for freeCal is officially maintained in the main freeCal repository. The Dockerfile and docker-compose.yml are located in the root of the [calcom/freeCal repository](https://github.com/calcom/freeCal).

If you want to contribute to the Docker setup, please open an issue or pull request in the [main freeCal repository](https://github.com/calcom/freeCal).
...
1. Clone the freeCal repository
...
For more detailed instructions on how to build and configure your own Docker image, refer to the Dockerfile and docker-compose.yml in the root of the [freeCal repository](https://github.com/calcom/freeCal).
