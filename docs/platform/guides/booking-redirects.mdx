...
An example implementation can be found [here](https://github.com/calcom/freeCal/blob/main/packages/platform/examples/base/src/pages/%5BbookingUid%5D.tsx).
...
An example implementation can be found [here](https://github.com/calcom/freeCal/blob/main/packages/platform/examples/base/src/pages/booking.tsx).
