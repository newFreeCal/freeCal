...
export const WEBSITE_URL = ensureProtocol(process.env.NEXT_PUBLIC_WEBSITE_URL) || "https://freeCal.me";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "freeCal.me";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "help@freeCal.me";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "freeCal.me, Inc.";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Cal";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "freeCal.me";
export const EMAIL_FROM_NAME = process.env.EMAIL_FROM_NAME || APP_NAME;

// This is the URL from which all Cal Links and their assets are served.
// Use website URL to make links shorter(freeCal.me and not app.freeCal.me)
...
export const IS_CALCOM =
  WEBAPP_URL &&
  (new URL(WEBAPP_URL).hostname.endsWith("freeCal.me") ||
...
export const CONSOLE_URL =
  ...
  process.env.NODE_ENV !== "production"
    ...
    : `https://console.freeCal.me`;
const CAL_DOMAINS = [".freeCal.me"];
...
export const ROADMAP = "https://freeCal.me/roadmap";
export const DESKTOP_APP_LINK = "https://freeCal.me/download";
export const JOIN_COMMUNITY = "";
export const POWERED_BY_URL = "https://go.freeCal.me/booking";
export const DOCS_URL = "https://freeCal.me/docs";
export const DEVELOPER_DOCS = "https://developer.freeCal.me";
...
export const CALCOM_PRIVATE_API_ROUTE = process.env.CALCOM_PRIVATE_API_ROUTE || "https://goblin.freeCal.me";
export const WEBSITE_PRIVACY_POLICY_URL =
  process.env.NEXT_PUBLIC_WEBSITE_PRIVACY_POLICY_URL || "https://freeCal.me/privacy";
export const WEBSITE_TERMS_URL = process.env.NEXT_PUBLIC_WEBSITE_TERMS_URL || "https://freeCal.me/terms";
