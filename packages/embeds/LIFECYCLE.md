# freeCal Embed Lifecycle Events

This document details the lifecycle events and states of freeCal embeds, showing the interaction flow between the parent page and the iframe.
...
All messages use the `originator: "CAL"` identifier to distinguish freeCal embed messages:
