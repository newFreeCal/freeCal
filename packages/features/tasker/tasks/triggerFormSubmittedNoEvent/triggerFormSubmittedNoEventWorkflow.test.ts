...
import { scheduleWorkflowReminders } from "@calcom/ee/workflows/lib/reminders/scheduleWorkflowReminders.ts";
...
vi.mock("@calcom/ee/workflows/lib/reminders/scheduleWorkflowReminders.ts", () => ({
