...
vi.mock("@calcom/features/common/lib/stubs/server/LicenseKeyService", createLicenseKeyMock);
vi.mock(
  "@calcom/features/deployment/lib/stubs/repositories/DeploymentRepository",
  createDeploymentRepositoryMock
);
