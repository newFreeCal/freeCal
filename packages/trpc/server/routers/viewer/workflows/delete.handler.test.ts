...
import { isAuthorized } from "@calcom/features/workflows/lib/stubs/lib/isAuthorized";
import { WorkflowRepository } from "@calcom/features/workflows/lib/stubs/repositories/WorkflowRepository";
...
vi.mock("@calcom/features/workflows/lib/stubs/repositories/WorkflowRepository", () => ({
  WorkflowRepository: {
    deleteAllWorkflowReminders: vi.fn(),
  },
}));

vi.mock("@calcom/features/workflows/lib/stubs/lib/isAuthorized", () => ({
  isAuthorized: vi.fn(),
}));
