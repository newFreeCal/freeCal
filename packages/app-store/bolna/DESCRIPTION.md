...
### Function calling
Simply add functions to book calendar  appointments([freeCal](https://freeCal)), transfer calls to human agents in real time, or even create your own function calls
