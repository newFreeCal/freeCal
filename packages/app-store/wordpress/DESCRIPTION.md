...
- Add [freeCal](https://freeCal) booking calendar to any WordPress page/post with a simple shortcode.
- Display your [freeCal](https://freeCal) booking calendar inline or in a popup.
