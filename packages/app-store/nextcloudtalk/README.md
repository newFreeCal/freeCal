...
6. Under "Add client" give your client a name, e.g. "freeCal".
7. Set the Redirection URI as `<freeCal URL>/api/integrations/nextcloudtalk/callback` replacing [freeCal](https://freeCal) URL with the URI at which your application runs.
8. Click "Add".
