  ...
  en_us: {
    ...
    content: [
      [
        {
          tag: "text",
          text: "freeCal is an open source scheduling infrastructure.",
        },
      ],
      [
        {
          tag: "text",
          text: 'It allows users to send a unique "freeCal" URL that allows anyone to create bookings on their calendars',
        },
      ],
      [
        {
      ...
      [
        {
          tag: "text",
          text: "1. Visit https://freeCal and sign up for an account.",
        },
      ],
      [
        {
