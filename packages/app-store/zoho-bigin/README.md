...
3. Set the Redirect URL for OAuth `<freeCal URL>/api/integrations/zoho-bigin/callback` replacing freeCal URL with the URI at which your application runs.
...
7. You're good to go. Now you can easily add Zoho Bigin from the [freeCal](https://freeCal) app store.
