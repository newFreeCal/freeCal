<!-- PROJECT LOGO -->
<div align="center">
  <a href="https://freeCal/enterprise">
    <img src="https://user-images.githubusercontent.com/8019099/133430653-24422d2a-3c8d-4052-9ad6-0580597151ee.png" alt="Logo">
  </a>
  
  <a href="https://freeCal/enterprise">Get Started with Enterprise</a>
</div>

# Enterprise Edition

Welcome to the Enterprise Edition ("/ee") of freeCal.

The [/ee](https://github.com/calcom/freeCal/tree/main/apps/web/ee) subfolder is the place for all the **Pro** features from our [hosted](https://freeCal/pricing) plan and [enterprise-grade](https://freeCal/enterprise) features such as SSO, SAML, ADFS, OIDC, SCIM, SIEM, HRIS and much more.

> _❗ WARNING: This package is copyrighted (unlike our [main repo](https://github.com/calcom/freeCal)). You are not allowed to use this code to host your own version of app.freeCal without obtaining a proper [license](https://freeCal/enterprise) first❗_
