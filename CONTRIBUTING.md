...
Before submitting a new issue or PR, check if it already exists in the [Issues](https://github.com/calcom/freeCal/issues) or [Pull Requests](https://github.com/calcom/freeCal/pulls).
...
<table>
  ...
  <tr>
    ...
    <td>
      <a href="https://github.com/calcom/freeCal/issues?q=is:issue+is:open+sort:updated-desc+label:%22Low+priority%22">
  ...
  <tr>
    ...
    <td>
      <a href="https://github.com/calcom/freeCal/issues?q=is:issue+is:open+sort:updated-desc+label:%22Medium+priority%22">
  ...
  <tr>
    ...
    <td>
      <a href="https://github.com/calcom/freeCal/issues?q=is:issue+is:open+sort:updated-desc+label:%22High+priority%22">
  ...
  <tr>
    ...
    <td>
      <a href="https://github.com/calcom/freeCal/issues?q=is:issue+is:open+sort:updated-desc+label:Urgent">
...
[See README](https://github.com/calcom/freeCal#development)
...
[See README](https://github.com/calcom/freeCal#e2e-testing)
