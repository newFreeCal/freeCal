...
Detailed documentation for calendar integration endpoints in the freeCal API v2.
...
freeCal events in external calendars can be identified by their iCalUID ending with `@freeCal` (e.g., `2GBXSdEixretciJfKVmYN8@freeCal`).
