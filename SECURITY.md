...
Contact: [security@freeCal](mailto:security@freeCal)

Based on [https://supabase.com/.well-known/security.txt](https://supabase.com/.well-known/security.txt)

At freeCal, we consider the security of our systems a top priority. But no
...
- E-mail your findings to [security@freeCal](mailto:security@freeCal).
